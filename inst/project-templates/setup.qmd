...
df_main <- df_main %>%
  set_derived_variable_labels(path = {{do.call(here::here, list(getOption("croquet.name"), stringr::str_glue("derived-variables_{sub('^\\\\d{2}-', '', getOption('croquet.name'))}.xlsx")) |> purrr::discard(rlang::is_empty)) |> shQuote()}})
