...
#| fig.alt: >
#|   Shows two tabs named dat1 and dat2. Row 1 has a light gray background and
#|   dark text; row 2 has a black background and white text.
...
This imports a single sheet that assumes variables names are in row 1 and variable
labels are row 2. You can optionally specify a regex expression for `date_detect` 
